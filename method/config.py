...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--eval_query_bsz", type=int, default=20000, help="minibatch size at inference for query") # ori: 50
        self.parser.add_argument("--eval_context_bsz", type=int, default=20,
        ...
        self.parser.add_argument("--model_name", type=str, default='PEAN')
